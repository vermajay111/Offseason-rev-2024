...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 14.5 * 2.54; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 7.5 * 2.54; // in; offset of the lateral wheel
